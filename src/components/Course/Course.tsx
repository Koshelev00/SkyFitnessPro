          ...
          <div className="flex flex-col gap-[17px] mt-10 lg:flex-row">
            {fittingItems.map((fit, index) => {
              const getWidthClass = () => {
                switch (index) {
                  case 0:
                    return "w-full lg:w-[368px] md:w-[431px]";
                  case 1:
                    return "w-full lg:w-[431px] md:w-[431px]";
                  case 2:
                    return "w-full lg:w-[327px] md:w-[431px]";
                  default:
                    return "w-full";
                }
              };
            ...
            {directionItems.map((direction, index) => (
              <div key={index} className="flex gap-2 items-center">
                <Image
                  ...
                  alt="Sparcle"
                />
                <p className="text-[18px] md:text-[24px] font-normal leading-7">
                  {direction}
                </p>
              </div>
            ))}
