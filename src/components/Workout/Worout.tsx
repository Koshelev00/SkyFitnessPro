...
<div className="mt-10">
    <iframe src="https://vkvideo.ru/video-223467206_456239092"  className="w-[1160px] h-[639px] rounded-[36px]"></iframe>
</div>
<div className="mt-10 rounded-[30px] bg-[#FFFFFF] shadow-2xl p-10">
    <h2 className="text-[#001] text-[32px] font-normal ">Упражнения тренировки 2</h2>
